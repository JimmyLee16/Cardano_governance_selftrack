...
from helpers import get_logger, check_env, neon_connect, neon_row_count
...
def main():
    ...
    logger.info("=" * 55)
    logger.info("  Neon DB Verification")
    logger.info("=" * 55)
    ...
    for table in sorted(tables):
        try:
            count = neon_row_count(conn, table)
